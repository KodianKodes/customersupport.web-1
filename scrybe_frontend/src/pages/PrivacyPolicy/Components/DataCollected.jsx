...
function DataCollected() {
  return (
    <div className='sub-container'>
        ...
        <div>
            <h1>Personal Data</h1>
            <p>While using our Service, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you (<span>“Personal Data”</span>). Personally identifiable information may include, but is not limited to:</p>
            <div>
                <ol>
                    <li>Email address</li>
        ...
        <div>
            <h1>Usage Data</h1>
            <p>We may also collect information that your browser sends whenever you visit our Service or when you access Service by or through any device(<span>Usage Data”</span>). </p>
