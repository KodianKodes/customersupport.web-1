...
function DataProtectionRights() {
  return (
    <div className='sub-container'>
        <h1>12. Your Data Protection Rights under the Nigerian Data Protection Regulation (NDPR)</h1>
        <p>This Privacy And Cookies Policy Is Intended To Meet Our Obligations Under The "Nigerian Data Protection Regulation" Or NDPR, A Legal Framework That Sets Guidelines For The Protection And Processing Of Personal Information Of Individuals Within Nigeria Or Residing Outside Nigeria But Of Nigerian Descent.</p>
        <h1>1. What personal information we have about you. If you make this request, we will return to you.</h1>
        <ul>
        ...
        <ol>
          <li><h1> To delete your personal information. If you make this request, we will delete the personal information we hold about you as of the date of your request from our records and direct any service providers to do the same. In some cases, deletion may be accomplished through de-identification of the information. If you choose to delete your personal information, you may not be able to use certain functions that require your personal information to operate.</h1></li>
